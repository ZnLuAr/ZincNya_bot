...
MODULES = {
    ...
    "afc": {
        "id": "afc",
        "name": "AFC 工具调用",
        "description": "Automatic Function Calling：检测用户意图，让 LLM 自主调用外部工具（天气、计算器等）",
        "version": "1.0.0",
        "author": "ZincPhos",
        "files": [
            "handlers/afc.py",
            ...
            "utils/afc/tools/calc/config.py",
            "utils/afc/tools/calc/errors.py",
            "utils/afc/tools/calc/operators.py",
            "utils/afc/tools/calc/calculator.py",
            "utils/afc/tools/calc/README.md",
            "utils/afc/tools/datetime/__init__.py",
            "utils/afc/tools/datetime/triggers.py",
            "utils/afc/tools/datetime/config.py",
            "utils/afc/tools/datetime/core.py",
            "utils/afc/tools/datetime/README.md",
        ...
        "initFunctions": [
            "utils.afc.tools.weather.client:_registerResources",
        ],
        "backgroundTasks": [],
        "dependencies": ["llm"],
        "githubRepo": None,
    ...
    "stickers": {
        "id": "stickers",
        "name": "表情包下载",
        "description": "下载 Telegram 表情包为图片或 GIF，支持大文件分卷发送与内存监控",
        "version": "1.0.0",
        "author": "ZincPhos",
        "files": [
        ...
        "initFunctions": [],
        "backgroundTasks": [
            "utils.memoryMonitor:monitorMemory",
        ],
        "dependencies": [],
        "githubRepo": None,
    },
